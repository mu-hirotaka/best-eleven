...
(function() {
  $(function() {
    ...
    getQueryString = function() {
      var element, key, param, params, query, res, value, _i, _len;
    ...
    $('.question.index').ready(function() {
      localStorage.clear();
      return $('.question-each-btn').on({
        click: function() {
          var $this, questionId;
          $this = $(this);
          ...
          return location.href = '/formation' + '?qid=' + questionId;
        }
      });
    });
    $('.formation.index').ready(function() {
      var $pointBtn, $tweetBtn, height, width;
      $pointBtn = $('.goodBtn');
      $tweetBtn = $('.twBtn');
      ...
      $('.user-post-image-question').css({
        width: width
      });
      $('.sns_btn').css({
        width: width
      });
      $('.user-image-opinion').css({
        width: width
      });
      $('.user-image-opinion-btn').css({
        width: width
      });
      $('.arrow_box').css({
        width: width
      });
      $('.other-user-comment').css({
        width: width
      });
      $pointBtn.each(function() {
        var $this;
        $this = $(this);
      ...
      $pointBtn.on({
        click: function() {
          ...
          return $.ajax('/user_post_images/good', {
            type: 'POST',
            dataType: 'json',
            data: {
              id: id
      ...
      return $('.formation-each-btn').on({
        click: function() {
          var $this, formationId;
          $this = $(this);
          ...
          return location.href = '/selection?foId=' + formationId;
        }
      });
    });
    $('.selection.index').ready(function() {
      var $comment, $createBtn, $formationChangeBtn, $position, fid, halfSize, height, i, internalComment, isValidSelection, pid, pidCache, playerNameCache, queryParams, size, width, _i;
      ...
      for (i = _i = 1; _i <= 11; i = ++_i) {
        ...
        $('.position-' + i).on({
          click: function() {
            ...
            return location.href = '/selection/select?bid=' + bid + '&fid=' + fid + '&qid=' + qid;
          }
        });
      }
      ...
      $createBtn.on({
        click: function() {
          ...
          return location.href = '/selection/show';
        }
      });
      return $formationChangeBtn.on({
        click: function() {
          return location.href = '/formation?qid=' + localStorage.getItem('current-question-id');
        }
      });
    });
    $('.selection.select').ready(function() {
      var $positionAll, $positionDf, $positionFw, $positionGk, $positionMf, $storageAll, $storageDf, $storageFw, $storageGk, $storageMf, cache, fieldId, index, selector, _i;
      $positionAll = $('#position-all');
      $positionFw = $('#position-fw');
      $positionMf = $('#position-mf');
      $positionDf = $('#position-df');
      $positionGk = $('#position-gk');
      for (index = _i = 1; _i <= 11; index = ++_i) {
      ...
      $('.select-target > option').each(function() {
        var $this, positionNum;
        $this = $(this);
        $storageAll.append($this.clone());
        positionNum = parseInt($this.attr('data-position'));
        if (positionNum === 1) {
          return $storageFw.append($this.clone());
        } else if (positionNum === 2) {
          return $storageMf.append($this.clone());
        } else if (positionNum === 3) {
          return $storageDf.append($this.clone());
        } else if (positionNum === 4) {
          return $storageGk.append($this.clone());
        } else {
      ...
      $('.select-target').on({
        change: function() {
          var $after, $afterPlayerName, $selected, playerId, tmpKeyName;
          ...
          if (playerId > 0) {
            ...
            return localStorage.setItem(tmpKeyName, $selected.text());
          } else {
            $afterPlayerName.text('');
            return localStorage.removeItem(tmpKeyName);
          }
        }
      });
      $('#select-done-btn').on({
        click: function() {
          var $after, keyName, playerId, tmpKeyName;
          $after = $('#select-player-after');
          ...
          return location.href = '/selection?aid=' + playerId + '&fid=' + fieldId;
        }
      });
      $positionAll.on({
        click: function() {
          ...
          $('.select-target').empty();
          return $('.select-target').append($storageAll.children().clone());
        }
      });
      $positionFw.on({
        click: function() {
          ...
          $positionGk.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageFw.children().clone());
        }
      });
      $positionMf.on({
        click: function() {
          ...
          $positionGk.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageMf.children().clone());
        }
      });
      $positionDf.on({
        click: function() {
          ...
          $positionGk.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageDf.children().clone());
        }
      });
      return $positionGk.on({
        click: function() {
          ...
          $positionDf.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageGk.children().clone());
        }
      });
    });
    $('.selection.show').ready(function() {
      var $commentLength, $imageComment, $title, $tweetBtn, cache, fieldId, formationId, internalComment, players, qid, questionTitle, setCommentLength, url, _i;
      $tweetBtn = $('#twitter-tweet-btn');
      $imageComment = $('#user-image-comment');
      $commentLength = $('#user-image-comment-length');
      setCommentLength = function(init) {
        var length;
        ...
        if (length > 140) {
          ...
          return $tweetBtn.attr("disabled", "disabled");
        } else {
          ...
          if (!init) {
            ...
            return $tweetBtn.removeAttr("disabled");
          }
        }
      };
      qid = localStorage.getItem('current-question-id');
      ...
      players = [];
      for (fieldId = _i = 1; _i <= 11; fieldId = ++_i) {
      ...
      $imageComment.keyup(function(e) {
        return setCommentLength();
      });
      $tweetBtn.on({
        click: function() {
          localStorage.setItem('current-comment', $imageComment.val());
          return location.href = '/twitter';
        }
      });
      return $.ajax('/image/create', {
        type: 'POST',
        dataType: 'json',
        data: {
          players: players,
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          ...
          return $('#result-error-comment').show();
        },
        success: function(data, textStatus, jqXHR) {
    ...
    $('.twitter.index').ready(function() {
      var comment, url, user_post_image_id;
      ...
      return $.ajax('/twitter/tweet', {
        type: 'POST',
        dataType: 'json',
        data: {
          url: url,
          comment: comment,
          user_post_image_id: user_post_image_id
        },
        error: function(jqXHR, textStatus, errorThrown) {
        ...
        success: function(data, textStatus, jqXHR) {
          ...
          $('#spinner-container').hide();
          return $('#result-comment').show();
        }
      });
    });
    $('.user_post_images.index').ready(function() {
      var $pointBtn, $tweetBtn, height, width;
      $pointBtn = $('.goodBtn');
      $tweetBtn = $('.twBtn');
      width = Math.min($('.container').width(), 400);
    ...
    $('.user_post_images.index_order_by_point').ready(function() {
      var $pointBtn, $tweetBtn, height, width;
      $pointBtn = $('.goodBtn');
      $tweetBtn = $('.twBtn');
      width = Math.min($('.container').width(), 400);
    ...
    $('.user_post_images.index_order_by_comment').ready(function() {
      var $pointBtn, $tweetBtn, height, width;
      $pointBtn = $('.goodBtn');
      $tweetBtn = $('.twBtn');
      width = Math.min($('.container').width(), 400);
    ...
    $('.user_post_images.show').ready(function() {
      var $pointBtn, $tweetBtn, height, width;
      $pointBtn = $('.goodBtn');
      $tweetBtn = $('.twBtn');
      width = Math.min($('.container').width(), 400);
    ...
    $('.user_post_images.index_ranking').ready(function() {
      return $('.question-each-btn').on({
        click: function() {
          var $this, questionId;
          $this = $(this);
          questionId = $this.attr('data-question-id');
          return location.href = '/user_post_images/ranking' + '?qid=' + questionId;
        }
      });
    });
    $('.user_post_images.show_ranking').ready(function() {
      var $pointBtn, $tweetBtn, height, width;
      $pointBtn = $('.goodBtn');
      $tweetBtn = $('.twBtn');
      width = Math.min($('.container').width(), 400);
    ...
    $('.rankings.questions').ready(function() {
      return $('.question-each-btn').on({
        click: function() {
          var $this, questionId;
          $this = $(this);
          questionId = $this.attr('data-question-id');
          return location.href = '/rankings/question' + '?qid=' + questionId;
        }
      });
    });
    return $('.my_page.index').ready(function() {
      var $pointBtn, $tweetBtn, height, width;
      $pointBtn = $('.goodBtn');
      $tweetBtn = $('.twBtn');
      width = Math.min($('.container').width(), 400);
