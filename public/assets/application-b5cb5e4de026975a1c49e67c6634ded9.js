    ...
    $('.selection.select').ready(function() {
      ...
      $positionAll.on({
        click: function() {
          ...
          $('.select-target').empty();
          return $('.select-target').append($storageAll.children());
        }
      });
      $positionFw.on({
        click: function() {
          ...
          $positionGk.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageFw.children());
        }
      });
      $positionMf.on({
        click: function() {
          ...
          $positionGk.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageMf.children());
        }
      });
      $positionDf.on({
        click: function() {
          ...
          $positionGk.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageDf.children());
        }
      });
      return $positionGk.on({
        click: function() {
          ...
          $positionDf.addClass('btn-default');
          $('.select-target').empty();
          return $('.select-target').append($storageGk.children());
        }
      });
    });
