...
(function() {
  $(function() {
    ...
    $('.question.index').ready(function() {
      ...
      return $('.question-each-btn').on({
        click: function() {
          ...
          return location.href = '/formation';
        }
      });
    });
    ...
    $('.selection.index').ready(function() {
      var $comment, $createBtn, $position, fid, halfSize, height, i, internalComment, isValidSelection, pid, pidCache, queryParams, size, width, _i;
    ...
    $('.selection.select').ready(function() {
      $('.select-target').on({
        change: function() {
          ...
          return $('#select-player-after').attr('data-pid', $(this).val());
        }
      });
      return $('#select-done-btn').on({
        click: function() {
          ...
          return location.href = '/selection?aid=' + $after.attr('data-pid') + '&fid=' + $after.attr('data-fid');
        }
      });
    });
