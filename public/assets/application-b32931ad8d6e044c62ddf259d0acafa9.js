...
(function() {
  $(function() {
    ...
    $('.selection.index').ready(function() {
      var $createBtn, $position, fid, halfSize, height, i, isValidSelection, pid, pidCache, queryParams, size, width, _i;
    ...
    $('.selection.show').ready(function() {
      var $commentLength, $imageComment, $title, $tweetBtn, cache, fieldId, formationId, players, qid, questionTitle, setCommentLength, _i;
